...
//	void set_slicing_warning_gray(const std::string& text, bool g);
	...
	void remove_slicing_warnings_of_released_objects(const std::vector<ObjectID>& living_oids, int plate_id);	// Object partially outside of the printer working space, cannot print. No fade out.
